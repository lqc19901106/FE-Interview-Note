...
ts-loader、style-loader、css-loader、babel-loader、sass-loader
...
> plugin和loader的区别
>
> loader是一个转换器，将A文件进行编译形成B文件，这里操作的是文件，比如将A.scss转换为A.css，单纯的文件转换过程
>
